...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for a single hotel before a certain date.")]
    ...
    [KernelFunction]
    [Description("Get all bookings which are missing hotel rooms")]
    ...
    [KernelFunction]
    [Description("Get all bookings which have multiple")]
